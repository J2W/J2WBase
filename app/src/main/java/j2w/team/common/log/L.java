...
public final class L {
	...
	public static void init(boolean isLogOpen, Context context) {
		if (isLogOpen) {
            //打开图片加载标记
			J2WHelper.getPicasso().setIndicatorsEnabled(true);
	...
	/**
	 * A view into Timber's planted trees as a tree itself. This can be used for
	 * injecting a logger instance rather than using static methods or to
	 * facilitate testing.
	 */
	...
	public interface Tree {
		 ...
		 * 打印内存日志
		 */
		void m(String message, Object... args);
	...
	/**
	 * A facade for attaching tags to logging calls. Install instances via
	 * {@link #plant}
	 */
	...
	/**
	 * A {@link j2w.team.common.log.L.Tree} for debug builds. Automatically
	...
	/**
	 * A {@link j2w.team.common.log.L.Tree} which does nothing. Useful for
	 * extending.
	 */
