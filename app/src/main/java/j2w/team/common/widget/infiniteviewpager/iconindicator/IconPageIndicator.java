...
import j2w.team.R;
import j2w.team.common.widget.infiniteviewpager.PageIndicator;
...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < count; i++) {
            ImageView view = (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.j2w_view_icon_indicator,null);
