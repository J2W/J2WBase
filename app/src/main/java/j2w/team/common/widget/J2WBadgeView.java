...
public class J2WBadgeView extends TextView {
	...
	public J2WBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}

	public J2WBadgeView(Context context, AttributeSet attrs) {
	 ...
	 */
	public J2WBadgeView(Context context, View target) {
	 ...
	 */
	public J2WBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}

	public J2WBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}

	public J2WBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
