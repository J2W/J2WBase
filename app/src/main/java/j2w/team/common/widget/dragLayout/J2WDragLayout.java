...
public class J2WDragLayout extends FrameLayout {
	...
	public J2WDragLayout(Context context) {
		this(context, null);
	}

	public J2WDragLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		this.context = context;
	}

	public J2WDragLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	@Override protected void onFinishInflate() {
		...
		vg_main = (J2WRelativeLayout) getChildAt(isShowShadow ? 2 : 1);
