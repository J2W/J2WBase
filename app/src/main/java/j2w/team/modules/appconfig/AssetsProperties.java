...
public class AssetsProperties {
	...
	public String getString(String key, String defaultValue) {
		...
		try {
			result = new String(result.getBytes("ISO-8859-1"), DEFAULT_CODE);// 这一句是重点
	...
	private void setFieldValue(Field field, String propertiesName) {
		...
		try {
			...
			Log.e(TAG, "AssetsProperties : impossible to set value of field: " + field.getName() + " for " + propertiesName);
		}
	}
